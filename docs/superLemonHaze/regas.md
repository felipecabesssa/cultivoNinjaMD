# 🚿 Log de Nutrição e Regas - Super Lemon Haze

| Data | Fase | Volume (por planta) | Nutrição (por Litro) | Notas / QA |
| :--- | :--- | :--- | :--- | :--- |
| 11/04 | Berçário| 50ml | Água Pura | Manutenção de umidade no Carolina Soil. |
| 29/04 | Vega | - | E.C 450 (Base Leve)| Primeira rega com nutrição mineral. |
| 08/05 | Vega | - | Água (Detox) | Rega leve de limpeza pré-transplante. |
