...
- **Easycoco Parte A:** ~500ml restantes
- **Easycoco Parte B:** ~500ml restantes
- **CalMag:** 1 Frasco (Uso sob demanda)
- **Anticloro:** 1 Frasco (Gotas)

## 🛠️ Equipamento de Extração (Ice-o-Lator)
- [x] Bags de Filtragem (Micragens variadas)
- [x] Borrifador
- [x] Batedor de Argamassa (Aguardando entrega)
- [x] Balde 20L (Aguardando entrega)
