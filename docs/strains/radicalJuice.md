# 🍇 Radical Juice - Dossier Técnico (Ripper Seeds)

Este documento centraliza as informações genéticas, morfologia e referências de cultivo para a Radical Juice, servindo como guia para os ciclos atuais e futuros.

---

## 🧬 Genética e Perfil
- **Linhagem:** Tropicanna Cookies x Runtz.
- **Predominância:** Híbrida (Vigor Sativa com densidade Indica).
- **Tempo de Floração:** 70 - 75 dias (Flip realizado em 16/02/2026).
- **Terpenos:** Explosão de laranja cítrica, cremosidade de frutas vermelhas e uva.

---

## 🎥 Referências e Grow Reports (YouTube)

### 🚀 Seed to Harvest (Completo)
- **[Radical Juice - Grow Documentary](http://www.youtube.com/watch?v=mEUXcD9gCcs)**
    - *O que observar:* O desenvolvimento das flores na semana 7-8 e o nível de resina nas folhas próximas ao bud.
- **[Vegetative Stage & LST Training](http://www.youtube.com/watch?v=WeCPpQ5pGLw)**
    - *O que observar:* Comparação de vigor para o berçário das SLH.

### 🧊 Extração e Lavagem (Ice-o-Lator)
- **[Bubble Hash Basics & Washing](http://www.youtube.com/watch?v=oyPp_C0TKt8)**
    - *Insight:* Embora o vídeo fale de técnicas de poda, o canal foca em genéticas americanas (como as que compõem a Radical) ideais para lavagem.
- **[Ice-o-Lator Professional Techniques](https://www.youtube.com/watch?v=XW16C6-Y32k)**
    - *Dica:* Use para revisar o processo das bags de 45u e 73u antes do dia 15/05.

---

## 🛠️ Notas de Manejo Ninja (Específicas)

### 🌡️ Climatização (Target: 18°C)
Graças ao novo **AC EOS 12k**, a Radical Juice entrará no regime de "choque térmico" na reta final.
- **Objetivo:** Estimular a antocianina (tons roxos/rosados) herdados da Tropicanna Cookies.
- **Vantagem:** Temperaturas baixas preservam os terpenos voláteis de laranja, que se perdem acima de 25°C.

### 🚿 Estratégia de Flush Final
- **E.C Alvo:** Saída < 800 µS/cm.
- **P.H:** 6.0 - 6.2.
- **Obs:** A planta deve terminar o ciclo "amarela", consumindo todo o nitrogênio estocado nas folhas leque.

---

## 🗓️ Cronograma de Finalização
1. **27/04 a 09/05:** Regas exclusivas com água pura (Flush).
