...
| Data | Ambiente | Status | Obs/Ação |
| :--- | :--- | :--- | :--- |
| 26/03 | Flora | ✅ Estável | UR 55% c/ Ar-condicionado. |
| 26/03 | Vega | ✅ Pronto | Setup físico concluído. Aguardando solo. |
| 28/03 | Flora | ✅ Estável | UR 55% / 24°C. Radical Juice respondendo bem ao flush. |
...
| :--- | :--- | :--- | :--- | :--- |
| **Quarto (Flora)** | 12/12 | 09:00 | 21:00 | Radical Juice |
| **Sala (Vega)** | 18/06 | 06:00 | 00:00 | SLH (Manual até chegar timer) |
